...
const topicFaqs = {
  ...
  sports: [
      {
        question: `${cleanTitle} 일정은 어디에서 확인할 수 있나요?`,
        answer:
          "공식 대회 홈페이지, FIFA, AFC, KFA 같은 축구 관련 공식 채널에서 확인하는 것이 가장 정확합니다.",
      },
      {
        question: `${cleanTitle} 전망은 무엇을 기준으로 봐야 하나요?`,
        answer:
          "대표팀 전력, 조 편성, 상대국 전력, 최근 경기력, 부상 선수 여부, 경기 장소 등을 함께 보는 것이 좋습니다.",
      },
      {
        question: `${cleanTitle} 관련 글을 볼 때 주의할 점은 무엇인가요?`,
        answer:
          "단순 예측이나 기대감만 보기보다 공식 일정, 실제 전력 자료, 전문가 분석을 함께 확인하는 것이 좋습니다.",
      },
    ],
