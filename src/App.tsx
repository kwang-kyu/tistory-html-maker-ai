...
<div style="padding:16px; margin-bottom:24px; border-radius:12px; background:#f1f5f9;">
  ...
  ${
    platform === "tistory"
      ? "티스토리 HTML 최적화 글<br/>HTML 모드에 바로 붙여넣기 좋은 구조입니다."
      : platform === "wordpress"
      ? "워드프레스 SEO 글<br/>SEO 제목, 메타설명, 태그, 본문 구성에 활용할 수 있습니다."
      : platform === "blogger"
      ? "구글 블로거 글<br/>검색설명, 라벨, 본문 구성에 활용할 수 있습니다."
      : "네이버 블로그 체류시간형 글<br/>자연스러운 문단형 글과 이미지 위치 중심으로 활용할 수 있습니다."
  }
</div>
      ...
      <div style={styles.shell}>
        <header style={styles.header}>
          <div>
            ...
            티스토리 · 워드프레스 · 블로거 · 네이버 블로그용
            SEO 콘텐츠 구조와 HTML을 자동 생성합니다.
            </p>
          </div>
  ...
  {[
    ...
    >
      {item.label}
              ...
              {platform === "tistory" && "티스토리 HTML 최적화 글 생성"}
              {platform === "wordpress" && "SEO 제목 + 메타설명 + 본문 생성"}
              {platform === "blogger" && "검색설명 + 라벨 + 본문 생성"}
              {platform === "naver" && "체류시간형 네이버 블로그 글 생성"}
</p>
            ...
            <div style={styles.infoBox}>
              ...
              <ul>
                <li>공백 제외 1,500자 이상 본문 구조</li>
                <li>도입부</li>
                <li>핵심 내용 정리</li>
                <li>표 정리</li>
                <li>확인 방법</li>
                <li>제목 기반 외부 참고 링크 자동 추천</li>
                <li>주의사항</li>
                <li>이미지 삽입 위치 3곳</li>
                <li>내부링크 수정 자리</li>
                <li>마무리 안내문</li>
